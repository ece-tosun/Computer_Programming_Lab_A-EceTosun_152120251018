...
struct Song {
 ...
 {
    void addSong(string T,string A,int r1,r2,r3)
     {
...

{
  ...
  playlist_manager myPlaylist;
  myPlaylist.add_song("Dracula","Tame Impala and Jennie");
  myPlaylist.add_song("Papparazi","Lady Gaga");

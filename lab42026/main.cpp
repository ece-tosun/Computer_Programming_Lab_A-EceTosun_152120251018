...
struct Courier;
{
 ...
 void push (Package** top, string ID,string city,int l,int w,int h){
 ...
 *top=(*top)->next;
 ...
 void enquequeCourier(CourierQueue* q, string name,string vehicle)
...
oid dispatch(Package** top, CourierQueue* q)
{
